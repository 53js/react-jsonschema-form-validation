 ...
 * carrying a `~standard` property with this shape is accepted by
 * `useForm({ schema })` — Zod (>= 3.24), Valibot, ArkType, Effect Schema
 * implement it natively; JSON Schema goes through the bundled AJV provider
 * (`providers/ajv`). Only the members the library reads are declared.
 */
